...
df['Persistence'] = Persistence coefficient from Ridley et al. https://doi.org/10.1016/j.renene.2009.07.018
...
def boland(df):
    ...
    return kd
#------------------------------------------------------------------------------
# url: https://doi.org/10.1016/j.solener.2015.04.012
def engerer2(df):
    ...
    return kd
#------------------------------------------------------------------------------
# url: https://doi.org/10.1063/1.5097014
def engerer4(df):
...
def yang4(df):
    ...
    return kd
#------------------------------------------------------------------------------
# url: https://doi.org/10.1016/j.renene.2018.02.107
def starke1(df):
...
def starke2(df):
    ...
    return kd
#------------------------------------------------------------------------------
# url: https://doi.org/10.1016/j.renene.2021.05.108
def starke3_A(df):
...
def abreu_HighAlbedo(df):
    ...
    return kd
#------------------------------------------------------------------------------
# url: https://doi.org/10.1016/j.renene.2019.09.114
def every1(df):
...
def every2_Other(df):
    ...
    return kd
#------------------------------------------------------------------------------
# url: https://doi.org/10.1016/j.solener.2019.01.029
def paulescu(df):
    b0 = 1.0119
    b1 = -0.0316
    b2 = -0.0294
